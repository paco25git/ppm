...
#define J_GVSP_PIX_OCCUPY30BIT	0x001E0000		// YT: 2017/04/10 Added for new RGB10p and BGR10p
#define J_GVSP_PIX_OCCUPY32BIT	0x00200000
#define J_GVSP_PIX_OCCUPY36BIT	0x00240000
#define J_GVSP_PIX_OCCUPY40BIT	0x00280000
#define J_GVSP_PIX_OCCUPY48BIT	0x00300000
#define J_GVSP_PIX_OCCUPY64BIT	0x00400000
...
#define J_PFNC_PIX_MONO10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT | 0x0046)			// Corrected PFNC - Old value 0x8004
...
#define J_PFNC_PIX_MONO12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT | 0x0047)			// Corrected PFNC - Old value 0x8006
...
// New PFNC types
#define J_PFNC_PIX_BAYGR10_PACKED  (J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT  | 0x0056)         // Corrected PFNC - Old value 0x8026 
#define J_PFNC_PIX_BAYRG10_PACKED  (J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT  | 0x0058)         // Corrected PFNC - Old value 0x8027 
#define J_PFNC_PIX_BAYGB10_PACKED  (J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT  | 0x0054)         // Corrected PFNC - Old value 0x8028 
#define J_PFNC_PIX_BAYBG10_PACKED  (J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT  | 0x0052)         // Corrected PFNC - Old value 0x8029 
#define J_PFNC_PIX_BAYGR12_PACKED  (J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x0057)         // Corrected PFNC - Old value 0x802A 
#define J_PFNC_PIX_BAYRG12_PACKED  (J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x0059)         // Corrected PFNC - Old value 0x802B 
#define J_PFNC_PIX_BAYGB12_PACKED  (J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x0055)         // Corrected PFNC - Old value 0x802C 
#define J_PFNC_PIX_BAYBG12_PACKED  (J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x0053)         // Corrected PFNC - Old value 0x802D
...
// YT: 2017/04/11 Added RGB8/10/12/16 (same as J_GVSP_PIX_RGB8/10/12/16_PACKED)
//                      BGR8/10/12    (same as J_GVSP_PIX_BGR8/10/12_PACKED)
#define J_GVSP_PIX_RGB8				(J_GVSP_PIX_RGB8_PACKED)
#define J_GVSP_PIX_BGR8				(J_GVSP_PIX_BGR8_PACKED)
#define J_GVSP_PIX_RGB10			(J_GVSP_PIX_RGB10_PACKED)
#define J_GVSP_PIX_BGR10			(J_GVSP_PIX_BGR10_PACKED)
#define J_GVSP_PIX_RGB12			(J_GVSP_PIX_RGB12_PACKED)
#define J_GVSP_PIX_BGR12			(J_GVSP_PIX_BGR12_PACKED)
#define J_GVSP_PIX_RGB16			(J_GVSP_PIX_RGB16_PACKED)

// 26.3 RGB buffer format defines (PFNC types)
// YT: 2017/04/11 Added RGB8/10/12/16 (same as J_GVSP_PIX_RGB8/10/12/16)
//                      BGR8/10/12    (same as J_GVSP_PIX_BGR8/10/12)
//                      RGB10p/12p, BGR10p/12p
#define J_PFNC_PIX_RGB8				(J_GVSP_PIX_RGB8)
#define J_PFNC_PIX_BGR8				(J_GVSP_PIX_BGR8)
#define J_PFNC_PIX_RGB10			(J_GVSP_PIX_RGB10)
#define J_PFNC_PIX_BGR10			(J_GVSP_PIX_BGR10)
#define J_PFNC_PIX_RGB12			(J_GVSP_PIX_RGB12)
#define J_PFNC_PIX_BGR12			(J_GVSP_PIX_BGR12)
#define J_PFNC_PIX_RGB16			(J_GVSP_PIX_RGB16)
#define J_PFNC_PIX_RGB10_P			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY30BIT | 0x005C)
#define J_PFNC_PIX_BGR10_P			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY30BIT | 0x0048)
#define J_PFNC_PIX_RGB12_P			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY36BIT | 0x005D)
#define J_PFNC_PIX_BGR12_P			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY36BIT | 0x0049)
...
#define J_GVSP_PIX_RGBA8			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY32BIT | 0x0016)
#define J_GVSP_PIX_RGBA8_PACKED		(J_GVSP_PIX_RGBA8)

#define J_GVSP_PIX_BGRA8			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY32BIT | 0x0017)
#define J_GVSP_PIX_BGRA8_PACKED		(J_GVSP_PIX_BGRA8)

#define J_PFNC_PIX_RGBA8			(J_GVSP_PIX_RGBA8)
#define J_PFNC_PIX_RGBA10			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY64BIT | 0x005F)		//RGBa10
#define J_PFNC_PIX_RGBA10_P			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY40BIT | 0x0060)		//RGBa10p
#define J_PFNC_PIX_RGBA12			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY64BIT | 0x0061)		//RGBa12
#define J_PFNC_PIX_RGBA12_P			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x0062)		//RGBa12p
#define J_PFNC_PIX_RGBA14			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY64BIT | 0x0063)		//RGBa14
#define J_PFNC_PIX_RGBA16			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY64BIT | 0x0064)		//RGBa16

#define J_PFNC_PIX_BGRA8			(J_GVSP_PIX_BGRA8)
#define J_PFNC_PIX_BGRA10			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY64BIT | 0x004C)		//BGRa10
#define J_PFNC_PIX_BGRA10_P			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY40BIT | 0x004D)		//BGRa10p
#define J_PFNC_PIX_BGRA12		    (J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY64BIT | 0x004E)		//BGRa12
#define J_PFNC_PIX_BGRA12_P			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x004F)		//BGRa12p
#define J_PFNC_PIX_BGRA14			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY64BIT | 0x0050)		//BGRa14
#define J_PFNC_PIX_BGRA16			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY64BIT | 0x0051)		//BGRa16
...
// YT: 2017/04/11 Added as RGB8/10/12/16 (same as J_PF_RGB8/10/12/16_PACKED)
//                         BGR8/10/12    (same as J_PF_BGR8/10/12_PACKED)
#define J_PF_RGB8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB8)
#define J_PF_BGR8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGR8)
#define J_PF_RGB10					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB10)
#define J_PF_BGR10					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGR10)
#define J_PF_RGB12					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB12)
#define J_PF_BGR12					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGR12)
#define J_PF_RGB16					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB16)

// YT: 2017/04/11 Added as RGB10p/12p, BGR10p/12p
#define J_PF_RGB10_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_RGB10_P)
#define J_PF_BGR10_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_BGR10_P)
#define J_PF_RGB12_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_RGB12_P)
#define J_PF_BGR12_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_BGR12_P)
...
#define J_PF_RGBA8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGBA8)
#define J_PF_RGBA8_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGBA8_PACKED)
#define J_PF_RGBA10					(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_RGBA10)
#define J_PF_RGBA10_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_RGBA10_P)
#define J_PF_RGBA12					(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_RGBA12)
#define J_PF_RGBA12_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_RGBA12_P)
#define J_PF_RGBA14					(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_RGBA14)
#define J_PF_RGBA16					(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_RGBA16)

#define J_PF_BGRA8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGRA8)
#define J_PF_BGRA8_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGRA8_PACKED)
#define J_PF_BGRA10					(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_BGRA10)
#define J_PF_BGRA10_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_BGRA10_P)
#define J_PF_BGRA12					(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_BGRA12)
#define J_PF_BGRA12_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_BGRA12_P)
#define J_PF_BGRA14					(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_BGRA14)
#define J_PF_BGRA16					(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_BGRA16)
...
// YT: 2017/08/26 Added.
/// \brief Status of the image associated with \c J_tIMAGE_INFO
typedef enum _J_IMAGE_STATUS
{
   IMAGE_STATUS_NONE = 0,           //!< Image buffer is not allocated
   IMAGE_STATUS_EMPTY = 1,          //!< Image buffer is allocated but holds no image
   IMAGE_STATUS_ACQUISITION = 2,    //!< Image buffer holds an acquisition image
   IMAGE_STATUS_CONVERSION = 3,     //!< Image buffer holds a conversion image
} J_IMAGE_STATUS;
...
#     pragma pack (push, 1)
      ...
      typedef struct J_S_SINGLE_CHUNK_DATA
      {
...
//******************************************************************************************************************
/// \brief                      Get Chunk Data information associated with the buffer
/// \param [in] hDS             Handle to a valid data stream object, obtained by \c J_Camera_CreateDataStream() function.
/// \param [in] hBuf            Handle of the buffer to be queued, obtained by \c J_DataStream_AnnounceBuffer().
/// \param [in] pChunkData      Pointer to an array of J_SINGLE_CHUNK_DATA structures that will hold chunk parsing information
/// \param [in,out] piNumChunks Number of available chunks will be returned if pChunkData==NULL.
///                             When pChunkData points to the allocated J_SINGLE_CHUNK_DATA structure array then it needs to be set to the array count.
/// \retval                     Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_SINGLE_CHUNK_DATA
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE  __cdecl J_DataStream_GetBufferChunkData(STREAM_HANDLE hDS, BUF_HANDLE hBuf, J_SINGLE_CHUNK_DATA *pChunkData, size_t *piNumChunks);

//******************************************************************************************************************
/// \brief                      Attach new Chunk Data information to the camera nodemap. This should be done every time the chunk layout changes.
/// \param [in] hCam            Handle to a valid camera object, obtained by \c J_Camera_Open() function.
/// \param [in] pBuffer         Pointer to the buffer data (not the buffer handle!).
/// \param [in] pChunkData      Pointer to an array of J_SINGLE_CHUNK_DATA structures that holds the chunk parsing information
/// \param [in] iNumChunks      Number of chunks in the pChunkData.
/// \retval                     Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_DataStream_GetBufferChunkData, \c J_SINGLE_CHUNK_DATA
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE  __cdecl J_Camera_AttachChunkData(CAM_HANDLE hCam, uint8_t* pBuffer, J_SINGLE_CHUNK_DATA *pChunkData, size_t iNumChunks);

//******************************************************************************************************************
/// \brief                      Update the chunk data in the camera nodemap. This can only be done if \c J_Camera_AttachChunkData() has been called previously
/// \param [in] hCam            Handle to a valid camera object, obtained by \c J_Camera_Open() function.
/// \param [in] pBuffer         Pointer to the buffer data (not the buffer handle!).
/// \retval                     Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_DataStream_GetBufferChunkData, \c J_SINGLE_CHUNK_DATA
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE  __cdecl J_Camera_UpdateChunkData(CAM_HANDLE hCam, uint8_t* pBuffer);

//******************************************************************************************************************
/// \brief                      Detach Chunk Data information from the camera nodemap. This should be done every time the streamin is stopped.
/// \param [in] hCam            Handle to a valid camera object, obtained by \c J_Camera_Open() function.
/// \retval                     Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_Camera_AttachChunkData
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE  __cdecl J_Camera_DetachChunkData(CAM_HANDLE hCam);
...
typedef enum _J_PIXEL_FORMAT_TYPE
{
   ...
   PF_EXTRACT_ALPHA,         //!< Extract the Alpha channel from RGBa... BGa... images.
} J_PIXEL_FORMAT;
